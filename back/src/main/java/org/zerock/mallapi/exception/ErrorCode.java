...
public enum ErrorCode {
    ...
    FORBIDDEN(403, HttpStatus.FORBIDDEN, "ACCESS_DENIED"),
    ...
    SESSION_EXPIRED(401, HttpStatus.UNAUTHORIZED, "SESSION_EXPIRED"),

    MAX_SIZE_EXCEED(400, HttpStatus.BAD_REQUEST ,"MAX_SIZE_EXCEED"),

    TOSS_PAYMENT_FAIL(301, HttpStatus.BAD_REQUEST, "TOSS FAILED"),

    ALREADY_PROCESSED(409, HttpStatus.CONFLICT, "ALREADY_PROCESSED_PAYMENT"),
