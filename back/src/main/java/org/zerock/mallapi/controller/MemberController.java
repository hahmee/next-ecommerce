...
public class MemberController {
    ...
    public Map<String, MemberDTO> getProfile(String email) {
        //    public Map<String, MemberDTO> profile(@RequestHeader("Authorization") String authHeader, MemberDTO sendMemberDTO) {

        //서비스 호출
        MemberDTO profileDTO = memberService.getProfile(email);
