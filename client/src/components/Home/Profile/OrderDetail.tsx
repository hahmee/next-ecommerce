        ...
        <div className="mb-15">
          ...
          <ul className="border border-gray-200 rounded p-3 text-xs">
            ...
            <li className="flex justify-between py-1.5">
              ...
              <span>
                {orders?.[0]?.createdAt ? dayjs(orders[0].createdAt).format('YYYY.MM.DD') : '-'}
              </span>
            </li>
            <li className="flex justify-between py-1.5">
              ...
              >
                ...
                <div className="flex gap-3 justify-between">
                  ...
                  <Link href={`/review-write?oid=${item.id}&orderId=${item.orderId}`}>
                    <button
                      type="button"
                      className="w-28 text-xs rounded ring-1 ring-ecom text-ecom py-2 px-4 hover:bg-ecom hover:text-white disabled:cursor-not-allowed disabled:bg-pink-200 disabled:ring-0 disabled:text-white disabled:ring-none"
                    >
                      리뷰쓰기
                    </button>
                  </Link>
