...
export function NavIconsView({
  ...
  return (
    <div className="flex items-center gap-4 xl:gap-6 relative">
      ...
      {accountOpen && (
        ...
        >
          <div className="relative">
            <Link href="/shopping"><div className="cursor-pointer">나의쇼핑</div></Link>
            <Link href="/review"><div className="mt-2 cursor-pointer">나의리뷰</div></Link>
      ...
      <Image src="/images/mall/notification.png" alt="알림" width={22} height={22} className="cursor-pointer" />
