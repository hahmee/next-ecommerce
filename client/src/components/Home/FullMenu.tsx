                ...
                <div role="list" className="flex items-center justify-center w-full text-sm font-medium text-gray-900">
                    {categories &&
                        categories.map((category) => (
                            <div key={category.cno} className="relative group">
                                <div
                                ...
                                {category.subCategories && (
                                    <div className="absolute w-56 rounded-lg bg-white shadow-lg top-12 z-20 transition-all duration-300 opacity-0 scale-95 group-hover:opacity-100 group-hover:scale-100">
