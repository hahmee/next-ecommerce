              ...
              <div className="absolute top-4 right-4">
                  {
                    ...
                    <button aria-label={"add-to-cart"} className="bg-white rounded-full p-2 shadow-md hover:bg-gray-100"
                            onClick={(e) => {
              ...
              <div className="flex mb-4.5" onClick={(e) => {
              ...
              }}>
                  {
                      product.colorList.map((value) => (
                        <div key={value.id} onClick={() => setColor(value)} className="w-5 h-5 rounded-full ring-gray-300 cursor-pointer relative mr-2" style={{backgroundColor: value.color}}>
                            {
                              value.id === color.id &&
