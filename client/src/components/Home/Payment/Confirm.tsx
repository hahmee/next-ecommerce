      ...
      <div className="min-h-screen bg-gray-100 flex items-center justify-center">
        <div className="bg-white p-8 rounded-lg shadow-lg max-w-lg w-full">
          ...
          <p className="text-gray-700 mb-4">
            주문번호: <strong>mock-order-123</strong>
          </p>
          <p className="text-gray-700 mb-4">
            총 결제 금액: <strong>10,000원</strong>
          </p>
    ...
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center">
        <div className="bg-white p-8 rounded-lg shadow-lg max-w-lg w-full">
          ...
          <div className="flex flex-col space-y-4">
            <Link href="/">
              <div className="w-full text-center text-sm rounded-md ring-1 ring-ecom text-ecom py-2 px-4 hover:bg-ecom hover:text-white disabled:cursor-not-allowed disabled:bg-pink-200 disabled:ring-0 disabled:text-white disabled:ring-none">
                계속 쇼핑하기
              </div>
            </Link>
