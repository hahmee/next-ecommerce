...
export function PaymentTableView(props: {
  ...
  const { list, paging, page, size, search, date, handleSearch, changeSize, changePage, dateChange } = props;
    ...
    <div className="bg-white dark:bg-gray-800 shadow-md rounded-sm mt-8">
      ...
      <div className="w-auto overflow-x-auto overflow-y-hidden relative">
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400 relative">
          ...
          <tbody>
          {list.map((p, idx) => (
            <tr className="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700" key={idx}>
              ...
              <td className="px-4 py-3 whitespace-nowrap">
                <p className="truncate overflow-hidden text-ellipsis whitespace-nowrap max-w-80">{p.owner.email}</p>
              </td>
