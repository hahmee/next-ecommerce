                                ...
                                >
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <div className="text-sm text-gray-500 mt-1 flex items-center gap-2">
                                            <span className="w-10 h-5 rounded-lg" style={{backgroundColor: product.colorList[0].color}}></span>
                                            <span className="flex items-center">
                                               <StarIcon className="w-4 h-4 text-ecom"/> {product.averageRating} ({product.reviewCount} reviews)
                                            </span>
                                        </div>
