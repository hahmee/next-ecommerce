    ...
    return (
        <div className="grid grid-cols-3 divide-x mb-4 md:mb-6 2xl:mb-7.5 rounded-sm border px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark bg-white">
            ...
            <div className="pr-7.5 pl-7.5">
                <CardItemTraffic title={"Unique visitors"} value={gaData?.uniqueVisitors} comparedValue = {gaData?.uniqueVisitorsCompared}/>
            </div>
            <div className="pl-7.5">
                <CardItemTraffic title={"Avg. session duration"} value={gaData?.avgSessionDuration} comparedValue={gaData?.avgSessionDurationCompared}/>
            </div>
