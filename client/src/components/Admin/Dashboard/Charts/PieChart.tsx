...
const PieChart = ({data, title, label}:{data:Array<SessionDTO<number>> | undefined , title: string, label:string}) => {
  ...
  const options: ApexOptions = {
    ...
    colors: colors, // ["#3C50E0", "#6577F3", "#8FD0EF", "#0FADCF"],
    labels: labels, //["Desktop", "Tablet", "Mobile", "Unknown"],
    legend: {
      show: false,
      position: "bottom",
    },
  ...
  return (
      <div className="rounded-sm px-5 pb-5 pt-7.5 border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-4">
