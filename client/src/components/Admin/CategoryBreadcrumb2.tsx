...
import {Mode} from "@/app/(admin)/@modal/(.)category/add-category2/page";
...
const CategoryBreadcrumb2 = ({clickedCt, categories, newCategory, mode}: BreadcrumbProps) => {
...
export default CategoryBreadcrumb2;
