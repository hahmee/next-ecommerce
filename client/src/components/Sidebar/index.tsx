...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        label: "Dashboard",
        route: "#",
        children: [{label: "Sales Overview", route: "/admin/dashboard/sales"}, {label: "Traffic Overview", route: "/admin/dashboard/traffic"},{label: "Real-time Overview", route: "/admin/dashboard/real-time"}],
      },
      {
        icon: (
            <svg
