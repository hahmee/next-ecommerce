  ...
  return (
    <div className="bg-white dark:bg-gray-800 shadow-md rounded-sm ">
      <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
        ...
        <div className="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
          ...
          <div className="flex items-center space-x-3">
            <div className="h-10 w-10 bg-gray-200 rounded dark:bg-gray-600" />
            <div className="h-10 w-10 bg-gray-200 rounded dark:bg-gray-600" />
          </div>
        </div>
      </div>
              ...
              {Array(11)
                ...
                .map((_, index) => (
                  <th key={index} scope="col" className="px-4 py-3">
                    <div className="h-4 bg-gray-200 rounded dark:bg-gray-600" />
                  </th>
                ))}
            </tr>
          </thead>
      ...
      <div className="px-4 py-6 md:px-6 xl:px-7.5 flex justify-between items-center">
        <div className="h-8 w-24 bg-gray-200 rounded dark:bg-gray-600" />
        <div className="flex space-x-2">
          {Array(5)
            .fill('')
            .map((_, index) => (
              <div key={index} className="h-8 w-8 bg-gray-200 rounded-full dark:bg-gray-600" />
            ))}
        </div>
      </div>
    </div>
