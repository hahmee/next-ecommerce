// src/shared/ui/skeletons/ProductCartSkeleton.tsx
  ...
  return (
    <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-6 gap-y-10 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3">
      <div className="group relative transition-shadow duration-300">
        {/* 이미지 부분 */}
        <div className="w-full bg-gray-200 h-80 rounded-2xl animate-pulse" />
        ...
        <div className="mt-4 px-4 pb-4">
          ...
          {/* 상품명 */}
          <div className="h-5 bg-gray-200 rounded-md w-3/4 mb-2 animate-pulse" />
          ...
          <div className="flex justify-between items-center mt-2">
            ...
            <div className="flex items-center">
              ...
              <div className="ml-1 h-4 bg-gray-200 rounded-md w-24 animate-pulse" />
            </div>
          </div>
        </div>
      </div>
