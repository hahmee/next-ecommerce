...
const FullMenuSkeleton = () => {
  return (
    <div className="hidden xl:flex gap-4 relative">
      {/* 모달 바깥 클릭 */}
      <div className="z-1 fixed w-full overflow-hidden h-screen top-0 left-0" />
          ...
          {[1, 2, 3, 4, 5, 6].map((_, index) => (
            <Fragment key={index}>
              <div className="relative flex items-center cursor-pointer px-3 gap-0.5 mx-1.5 py-2.5">
                ...
                <div className="absolute w-56 rounded-lg bg-white shadow-lg top-12 z-20 opacity-0 scale-95 pointer-events-none">
