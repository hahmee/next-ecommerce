            ...
            <div className="p-6.5">
              ...
              <div className="mb-4.5">
                ...
                <RadioButton
                  ...
                  originalData={original?.salesStatus}
                />
              </div>
            ...
            <div className="p-6.5">
              ...
              <div className="mb-4.5">
                <ColorSelector
                  ...
                  originalData={original?.colorList}
                />
              </div>
            </div>
          </section>
            ...
            <div className="p-6.5">
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  rows={3}
                  required
                  defaultValue={original?.refundPolicy ?? ''}
                  className="w-full rounded border-[1.5px] px-5 py-3"
                />
              </div>
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  rows={3}
                  required
                  defaultValue={original?.changePolicy ?? ''}
                  className="w-full rounded border-[1.5px] px-5 py-3"
                />
              </div>
            </div>
