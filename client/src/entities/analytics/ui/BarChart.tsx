...
export const BarChart = ({
  ...
  return (
    <div className="w-full bg-gray-200 rounded h-6">
      <div className="bg-primary-500/80 h-full rounded" style={{ width: `${percentage}%` }} />
    </div>
  );
};
  ...
  return (
    <div className="flex items-center">
      ...
      <div className="w-full bg-gray-200 rounded h-2 mr-2">
        <div className="bg-primary-500 h-full rounded" style={{ width: `${percentage}%` }} />
      </div>
      {/* 퍼센티지 텍스트 */}
