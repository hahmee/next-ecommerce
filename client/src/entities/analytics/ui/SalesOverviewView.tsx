...
const AdminDatePicker = dynamic(() => import('./AdminDatePicker'), { ssr: false });

export function SalesOverviewView(props: {
  date: DatepickType;
  comparedDate: DatepickType;
  currentFilter: ChartFilter;
  selectedCard: ChartContext;
  salesCards?: CardResponse;
  salesCharts?: ChartResponse;
  maxDate: Date;
  dateChange: (v: DateValueType) => void;
  filterChange: (f: ChartFilter) => void;
