...
describe("AddCart Component", () => {
    ...
    it('should render the AddCart component', () => {
        render(<AddCart pno={pno} salesStatus={SalesStatus.ONSALE} options={options} sellerEmail={sellerEmail}/>);
    ...
    it('should disable Add to Cart button if the status is not ONSALE', () => {
        render(<AddCart pno={pno} salesStatus={SalesStatus.SOLDOUT} options={options} sellerEmail={sellerEmail} />);
